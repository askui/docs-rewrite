...
<Aside type="note">
Ported from the previous documentation. The Python SDK references from the
original have been removed — AgentOS is now driven by AskUI Desktop and the CLI.
</Aside>
