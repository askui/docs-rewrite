...
<CardGrid>
  <LinkCard title="Capabilities" href={`${import.meta.env.BASE_URL}agentos/understanding/capabilities/`} description="Full list of capabilities by control mode." />
  <LinkCard title="Deployment" href={`${import.meta.env.BASE_URL}agentos/how-to-guides/deployment-local/`} description="Find the right setup for your target." />
  <LinkCard title="Runtime Modes" href={`${import.meta.env.BASE_URL}agentos/understanding/runtime-modes/`} description="Standalone vs OS service — choose the right runtime." />
  <LinkCard title="Install as Service" href={`${import.meta.env.BASE_URL}agentos/installation/service/`} description="Set up AgentOS as a Windows service for CI/CD and enterprise." />
</CardGrid>
