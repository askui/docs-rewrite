...
Right-click the file → **Duplicate** — copies the case as a starting point
for a similar one.

### Rename

Right-click the file → **Rename**. The file name is the test's name in runs
and reports, so reports of old runs keep the old name.
