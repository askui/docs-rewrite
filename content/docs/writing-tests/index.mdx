...
after everything inside it. Running the `checkout` suite:

```mermaid
flowchart LR
  A[tests/<br/>setup.md] --> B[checkout/<br/>setup.md] --> C[pay_with_card] --> D[pay_with_invoice] --> E[checkout/<br/>teardown.md] --> F[tests/<br/>teardown.md]
