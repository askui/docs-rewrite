...
<Callout type="info" title="Or generate it from screenshots">
You don't have to write `ui.md` by hand: open it in the Tests editor and click
**Forge from screenshots** to have the model draft it from screenshots of your
app. See [Forge](/docs/extending/forge).
</Callout>
