...
3. Click **Accept & Create ui.md** to write the section, or **Add another UI
...
**Settings → Generation Model**. Generated context is a draft — read it and
