...
<Cards>
  ...
  <Card title="Desktop App" href="/docs/get-started/install-desktop">
    Install AskUI Desktop, connect your devices, and follow the workflow:
    write tests, run them, read the results.
  </Card>
  <Card title="Writing Tests" href="/docs/writing-tests">
    Test cases, plans, procedures, and prompts, how to author tests the
    agent runs reliably.
  </Card>
  <Card title="Running Tests" href="/docs/running-tests">
    Run from the app, schedule recurring runs, or go headless in CI with the
    CLI.
  </Card>
