...
The alarm-clock button at the top of the **Runs** page's sidebar opens the
same dialog without a preselected file: pick any plan or test of the
project in **What to run**, and the list below shows every schedule with an
on/off toggle, a pencil to edit its cadence, and delete. The Dashboard
shows the next few upcoming schedules at a glance.
