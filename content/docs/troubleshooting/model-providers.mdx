...
you have configured a [custom model provider](/docs/using-askui-desktop/model-providers).
...
4. Alternatively, switch back to the **AskUI hub** (Settings → Model Provider →
...
**What to do:**
1. Go to **Settings → Model Provider** and check the key you entered.
...
permission to use this model or feature. Some models (e.g. Claude Opus, GPT-4o)
...
**What to do:**
1. Go to **Settings → Model Provider** and check the **Model** field.
...
2. Check the **Base URL** in **Settings → Model Provider** — it should look like
