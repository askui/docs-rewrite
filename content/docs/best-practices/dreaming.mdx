...
Treat Dreaming as a **continuous improvement loop**: every round of runs feeds
back into your rules and tests, so the suite keeps getting better the more you run
it — it's not a replacement for reading a report. You still decide what's true:
