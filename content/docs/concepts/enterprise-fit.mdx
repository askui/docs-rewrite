...
| **IT security** | [What leaves the network](#what-leaves-the-network-and-how-to-stop-it), [What the agent may do on a machine](#what-the-agent-may-do-on-a-machine), [Telemetry](#telemetry-what-we-see), [Inbound ports](#what-talks-to-what) |
