...
flowchart LR
  ...
  D --> A
  D --> F
  D -->|"screenshots + step text"| M["model provider"]
```
...
flowchart LR
  ...
  R[("Git repository<br/>the project")]
  D --> R
  C --> R
