...
description: What runs where, what talks to what, what leaves your network, and what is stored where.
---

The evaluation questions first: screenshots of your applications go to an AI
model for the agent's decisions; everything else — testware, reports,
secrets — stays on your machines. Here is the full picture.
...
Each [loop iteration](/docs/concepts/how-askui-works#how-askui-agents-work) sends the
...
| Data | Location |
| --- | --- |
| Testware — tests, plans, prompts, tool config | The [project folder](/docs/projects), plain files, yours to version |
