...
- **The agent files**: *who* is testing: the four
  [system-prompt files](/docs/best-practices/agent-behavior) of the project, the
...
- **The testware**: *what* is tested: the phase's own file (`setup.md`, a
  ...
  [test plan](/docs/writing-tests/plans) that selected it. This is what changes
...
- **The limits and the default behavior in error cases**: what happens when
  ...
  ([the discipline](/docs/best-practices/agent-behavior#error-discipline-built-in)):
