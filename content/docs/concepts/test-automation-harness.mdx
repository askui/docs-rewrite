...
We build it for three things, because a CUA model left to itself is
expensive, erratic and slow at suite scale:
...
What the AskUI harness owns — what it hands each phase, what it enforces,
