...
([where it sits](/docs/concepts/how-askui-works#what-a-cua-agent-is-made-of)).

Each phase is one autonomous agent execution: read the file, drive the UI
through the [loop](/docs/concepts/how-askui-works#the-loop), write the report
as it goes.
...
[reason to use an agent at all](/docs/concepts/how-askui-works#why-not-a-script).
