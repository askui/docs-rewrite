...
Set the environment variable `ASKUI_USE_BUNDLED_JDK=1` before starting AskUI
Desktop. The app then ignores the machine's Java and downloads its own JDK 17
into the SDK folder during Set up; the Java your other software relies on
stays untouched.
