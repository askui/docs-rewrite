...
**Install:** `pip install askui-agent-os` → [Standalone](/docs/agentos/installation/standalone)
...
<Callout title="Note">You only need one of ADB or IDB depending on your target device — both are shown for completeness.</Callout>
