...
This variable is intentionally set to `false` when connecting to a remote AgentOS instance — see [Remote Windows VM](/docs/agentos/how-to-guides/deployment-ci/#remote-windows-vm).
