...
Installed machines update themselves every 2 days. To point them at an internal update server instead of `files.askui.com`, see [Updating](/docs/agentos/installation/updating#serve-updates-from-your-own-server).
