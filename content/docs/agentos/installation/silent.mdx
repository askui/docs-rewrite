...
<Cards>
  <DownloadLink title="AMD64 (x86_64)" href="https://files.askui.com/releases/Installer/Latest/AskUI-Agent-OS-Latest-Service-Installer-Win-AMD64.exe" description="Standard 64-bit Windows systems." source="docs_agentos_download" label="Intel / AMD" os="Windows" />
  <DownloadLink title="ARM64" href="https://files.askui.com/releases/Installer/Latest/AskUI-Agent-OS-Latest-Service-Installer-Win-ARM64.exe" description="ARM-based Windows devices." source="docs_agentos_download" label="ARM64" os="Windows" />
</Cards>
