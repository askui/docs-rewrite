...
| Self-hosted update source | Available | Point the AgentOS updater at your own artifact registry, see [Updating](/docs/agentos/installation/updating#change-the-update-feed). |
