...
Dreaming does **not** need a Git repository, and it never commits anything. Every
edit it applies is an ordinary change to a file in your project — the same as if
you had typed it yourself. If your project happens to be a Git repository, the
edits show up as normal uncommitted changes in the app's source-control view, so
you can inspect and revert them there; if it isn't, your backup is the safety
net.
