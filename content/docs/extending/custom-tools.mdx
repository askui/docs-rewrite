...
If you'd rather not write the C# yourself, click **Generate a tool** on the
...
3. Click **Accept & Generate Tool**. The `.cs` file is written into
...
You choose which model powers generation under **Settings → Generation
