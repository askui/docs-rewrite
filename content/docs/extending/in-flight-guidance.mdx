...
auditable. The run summary also shows a separate **In-Flight Guidance** line (total
tokens, cost and number of checks), priced at the reviewer model's own rate and kept
apart from your execution cost.
