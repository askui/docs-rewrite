...
| **Project** | A folder structure created by AskUI Desktop containing tests, prompts, procedures, plans, and secrets. The unit of work for authoring and running tests. |
